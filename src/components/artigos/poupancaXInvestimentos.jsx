...
import jsonContent from '../../artigos/json/PoupancaXInvestimentos/poupancaXInvestimentos.json';

const poupancaXInvestimentos = () => {
...
export default poupancaXInvestimentos;
// JSON Hash: ecde9d2a4f6de4ffc0b363c4058167eb
