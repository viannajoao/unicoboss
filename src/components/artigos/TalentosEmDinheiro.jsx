...
import jsonContent from '../../artigos/json/TalentosEmDinheiro/TalentosEmDinheiro.json';

const TalentosEmDinheiro = () => {
...
export default TalentosEmDinheiro;
// JSON Hash: 38101efb0ed9dacd93a096ce0ef45dbf
