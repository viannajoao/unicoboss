...
import jsonContent from '../../artigos/json/EconomizarMercado/EconomizarMercado.json';

const EconomizarMercado = () => {
...
export default EconomizarMercado;
// JSON Hash: d01108a1e22626f48ac53d900c864c3f
