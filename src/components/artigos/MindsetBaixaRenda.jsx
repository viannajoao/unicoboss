...
import jsonContent from '../../artigos/json/MindsetBaixaRenda/MindsetBaixaRenda.json';

const MindsetBaixaRenda = () => {
...
export default MindsetBaixaRenda;
// JSON Hash: d736b1d68f0ecc1170c4f1b7ac5a11bf
